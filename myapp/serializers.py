...
class CampaignSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['campaign_id', 'brand', 'product_name', 'product_type', 'product_image_url', 'product_description',
                  'target_pet_type', 'min_follower_count', 'style_tag', 'requested_at', 'application_deadline_at',
...
class CampaignListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Campaign
        fields = ['campaign_id', 'product_name', 'brand', 'product_image_url', 'requested_at',
...
class CampaignAcceptanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['campaign_acceptance_id', 'creator', 'campaign', 'acceptance_status', 'applied_at', 'accepted_at']
